...
Use curl (for Mac OS X):
     ...
     curl -o - https://raw.github.com/maruku/vimrc/master/auto-install.sh | sh

or wget (for most UNIX platforms):

     wget -O - https://raw.github.com/maruku/vimrc/master/auto-install.sh | sh
...
1. Check out from github
        ...
        git clone git://github.com/maruku/vimrc.git ~/.vim
        cd ~/.vim
...
1. Check out from github
        ...
        git clone git://github.com/maruku/vimrc.git vimfiles
        git submodule update --init
